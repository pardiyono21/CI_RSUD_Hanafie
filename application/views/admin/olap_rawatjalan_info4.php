                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2016_jan" class="collapse in">
                                                                            <table class="table-bordered-collapse">
                                                                                <?php
                                                                                foreach ($data_klinik2016 as $key) {
                                                                                 
                                                                                ?>
                                                                                <tr>
                                                                                    <th style="min-width: 200px"><?=$key->nama_klinik?></th>
                                                                                    <th style="min-width: 55px"><?=$key->jml_klinik?></th>
                                                                                </tr>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <th>
                                                                            <div id="collapse2016_<?=$bulan3++?>" class="collapse">
                                                                                <table class="table-bordered-collapse">
                                                                                    ...
                                                                                    ?>
                                                                                    <tr>
                                                                                        <th style="min-width: 200px"><?=$val->nama_klinik?></th>
                                                                                        <th style="min-width: 55px"><?=$val->jml_klinik?></th>
                                                                                    </tr>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2017_jan" class="collapse">
                                                                            <table class="table-bordered-collapse">
                                                                                <?php
                                                                                foreach ($data_klinik2017 as $key) {
                                      ...
                                      <script>
                                        ...
                                        var myChartline = new Chart(ctx, {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: 'Pasien Keseluruhan per Klinik'
                                                },
                                                scales: {
                                                  yAxes: [{
                                                      ticks: {

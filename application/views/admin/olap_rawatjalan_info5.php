                                ...
                                <div class="col-sm-8 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table-bordered-toggle" align="center">
                                            <thead>
                                                <tr>
                                                    <th colspan="3">Pasian Rawat Jalan </th>
                                                </tr>
                                                        ...
                                                        <div id="collapse2016" class="collapse in">
                                                            <table class="table-bordered-collapse">
                                                                <tr class="no">
                                                                    ...
                                                                    <th colspan="2" width="250">Jumlah Pasien Per Penyakit </th>
                                                                </tr>
                                                                <?php 
                                                                if (count($data_penyakit2016)>0) {
                                                                ?>
                                                                <tr>
                                                                    <th width="60">
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2016_jan" class="collapse in">
                                                                            <table class="table-bordered-collapse">
                                                                                <?php
                                                                                foreach ($data_penyakit2016 as $key) {
                                                                                 
                                                                                ?>
                                                                                <tr>
                                                                                    <th style="min-width: 200px"><?=$key->id_penyakit?></th>
                                                                                    <th style="min-width: 55px"><?=$key->jml_penyakit?></th>
                                                                                </tr>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <th>
                                                                            <div id="collapse2016_<?=$bulan3?>" class="collapse">
                                                                                <table class="table-bordered-collapse">
                                                                                    ...
                                                                                    ?>
                                                                                    <tr>
                                                                                        <th style="min-width: 200px"><?=$val->id_penyakit?></th>
                                                                                        <th style="min-width: 55px"><?=$val->jml_penyakit?></th>
                                                                                    </tr>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                    ...
                                                    <td colspan="4">
                                                        <div id="collapse2017" class="collapse">
                                                            <table class="table-bordered-collapse">
                                                                <tr class="no">
                                                                    <th width="100">Bulan </th>
                                                                    <th colspan="2" width="250">Jumlah Pasien Per Jenis Kelamin </th>
                                                                </tr>
                                                                <?php 
                                                                if (count($data_penyakit2017)>0) {
                                                                ?>
                                                                <tr>
                                                                    <th width="60">
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2017_jan" class="collapse">
                                                                            <table class="table-bordered-collapse">
                                                                                <?php
                                                                                foreach ($data_penyakit2017 as $key) {
                                    ...
                                    <div>
                                      ...
                                      <script>
                                        ...
                                        var barChartData = {
                                            ...
                                            datasets: [{
                                                label: 'Jumlah Pasien',
                                                backgroundColor: ['#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1','#71BDF1'],
                                                data: datareport
                                            }]
                                        };

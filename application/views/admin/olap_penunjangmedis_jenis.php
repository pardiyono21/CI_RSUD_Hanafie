                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table-bordered-toggle" align="center">
                                                ...
                                                <tr class="no">
                                                    <th>Bulan </th>
                                                    <th>Jumlah Pasien  </th>
                                                    <th colspan="2">Jumlah Pasien Per Jenis Penunjang Medis  </th>
                                                    
                                                </tr>
                                                <?php foreach ($pasien_jenis as $key): ?>
                                                <tr>
                            ...
                            <div class="row">
                                <div class="col-sm-7 col-xs-12">
                                    ...
                                    <div>
                                      ...
                                      <script>
                                        ...
                                        var jenis_rawat = <?=$jenis_rawat?>;
                                        var datajml = <?=$jml?>;


                                        var barChartData = {
                                            labels: ['Radiologi','Laboratorium'],
                                            datasets: [{
                                                label: 'Jumlah Pasien',
                                        ...
                                        var myChartline = new Chart(ctx, {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: 'Pasien Keseluruhan per Jenis Penunjang Medis'
                                                },
                                                scales: {
                                                  yAxes: [{
                                                      ticks: {
                                ...
                                <div class="col-sm-5 col-xs-12">
                                  <?php
                                    ...
                                    $jml_array = count(json_decode($jenis_rawat));
                                    if ($jml_array>5) {

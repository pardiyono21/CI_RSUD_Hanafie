                                ...
                                <div class="col-sm-8 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table-bordered-toggle" align="center">
                                            <thead>
                                                <tr>
                                                    <th colspan="3">Pasian Rawat Inap secara keseluruhan berdasarkan asuransi</th>
                                                </tr>
                                                                ...
                                                                foreach ($data_2016 as $key ) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th width="50">
                                                                            <?php 
                                                                            $grandTotal = 0;
                                                                            foreach ($key as $keyjml) { 
                                                                            
                                                                                $jml_bln = $keyjml->jml_asuransi;
                                                                                $grandTotal += $jml_bln;
                                                                            } 
                                                                            ...
                                                                            <div id="collapse2016_<?=$bulan3?>" class="collapse">
                                                                                <table class="table-bordered-collapse">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="min-width: 50px"><?=$val->jml_asuransi?></th>
                                                                                    </tr>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2017_jan" class="collapse">
                                                                            <table class="table-bordered-collapse">
                                                                                ...
                                                                                <tr>
                                                                                    <th style="min-width: 200px"><?=$key->id_asuransi?></th>
                                                                                    <th style="min-width: 50px"><?=$key->jml_asuransi?></th>
                                                                                </tr>
                                                                                <?php
                                                                                }
                                                                                ?>

                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <div id="collapse2016_jan" class="collapse in">
                                                                            <table class="table-bordered-collapse">
                                                                                <?php
                                                                                foreach ($jan_dokter2016 as $key) {
                                                                                 
                                                                                ?>
                                                                                <tr>
                                                                                    <th style="min-width: 200px"><?=$key->nama_dokter?></th>
                                                                                    <th style="min-width: 55px"><?=$key->jml?></th>
                                                                                </tr>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <th>
                                                                            <div id="collapse2016_<?=$bulan3?>" class="collapse">
                                                                                <table class="table-bordered-collapse">
                                                                                    ...
                                                                                    ?>
                                                                                    <tr>
                                                                                        <th style="min-width: 200px"><?=$val->nama_dokter?></th>
                                                                                        <th style="min-width: 55px"><?=$val->jml?></th>
                                                                                    </tr>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                      ...
                                      <script>
                                        ...
                                        var myChartline = new Chart(ctx, {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: 'Pasien Keseluruhan per Dokter'
                                                },
                                                scales: {
                                                  yAxes: [{
                                                      ticks: {
